...
const components = glob
  .sync("src/js/components/!(index).js")
  .reduce((components, file) => {
    const name = path.basename(file, ".js");

    components[name] = () =>
      util.compile(
        `${__dirname}/wrapper/component.js`,
        `dist/js/components/${name}`,
        {
          name,
          minify,
          ...
          aliases: {
            component: path.resolve(__dirname, "../src/js/components", name),
          },
...
const steps = {
  core: () =>
    util.compile("src/js/uikit-core.js", "./../src/js/uikit-core", { minify }),
  uikit: () => util.compile("src/js/uikit.js", "./../src/js/uikit", { minify }),
  icons: async () =>
    util.compile("build/wrapper/icons.js", "./../src/js/uikit-icons", {
      minify,
      name: "icons",
      replaces: { ICONS: await util.icons("{src/images,custom}/icons/*.svg") },
    }),
  tests: async () =>
    util.compile("tests/js/index.js", "tests/js/test", {
      minify,
      name: "test",
